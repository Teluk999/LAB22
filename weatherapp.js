      ...
      <head>
        ...
        <style>
          ...
          button {
            ...
            font-size: 1rem;
            background-color: #A52A2A; /* Dark Red button color */
            color: #fff;
            border: none;
            border-radius: 5px;
            cursor: pointer;
          ...
          if (apiRes.statusCode === 200) {
            ...
            const htmlResponse = `
              ...
              <body>
                ...
                <div class="weather-container">
                  <p><i class="fas fa-cloud icon"></i> Temperature: ${temperature}°F</p>
                  <p><i class="fas fa-cloud-sun icon"></i> Description: ${description}</p>
